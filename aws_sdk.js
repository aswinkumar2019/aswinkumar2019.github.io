_xamzrequire = function() {
    ...
    26: [ function(require, module, exports) {
        module.exports = {
            ...
            cloudfront: {
                name: "CloudFront",
                versions: [ "2013-05-12*", "2013-11-11*", "2014-05-31*", "2014-10-21*", "2014-11-06*", "2015-04-17*", "2015-07-27*", "2015-09-17*", "2016-01-13*", "2016-01-28*", "2016-08-01*", "2016-08-20*", "2016-09-07*", "2016-09-29*", "2016-11-25*", "2017-03-25*" ],
                cors: true
            },
            cloudhsm: {
                name: "CloudHSM",
...
}, {}, [ 96 ]);AWS.apiLoader.services["polly"]["2016-06-10"] = {
    version: "2.0",
    metadata: {
...
AWS.Rekognition = AWS.Service.defineService("rekognition", [ "2016-06-27" ]);AWS.apiLoader.services["rekognition"]["2016-06-27"] = {
    version: "2.0",
    metadata: {
...
AWS.Translate = AWS.Service.defineService("translate", [ "2017-07-01" ]);AWS.apiLoader.services["translate"]["2017-07-01"] = {
    version: "2.0",
    metadata: {
...
}, {}, [ 101 ]);AWS.apiLoader.services["sts"]["2011-06-15"] = {
    version: "2.0",
    metadata: {
